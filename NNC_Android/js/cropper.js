...
//				console.log('图片宽高:width:' + this.width + '_height:' + this.height);
			...
			this.areaDomP = document.createElement('div');
			this.areaDomP.className = 'cropperAreaP';
			
			
			this.conDom.appendChild(this.maskDom);
			this.conDom.appendChild(this.imgDom);
			this.conDom.appendChild(this.areaDomP);
			this.areaDomP.appendChild(this.areaDom);
