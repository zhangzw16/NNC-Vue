...
<div class="common_layer_frame">
    <form id="edit_weekly_recommend_sport_from" method="post">
        ...
        <input class="common_layer_td_right_input" name="menu" value="${weekly_recommend.menu}" type="hidden"/>
        ...
        <div class="common_layer_tr_div" style="height: 70px;position:relative">
          <label class="common_layer_td_left_label" style="position:absolute;left:20;top:10px">每周运动指导：</label>
          <textarea class="common_layer_td_right_input" name="sport" rows="3" style="width:400px;padding:5px 10px;height: 80px;position:absolute;left:120px;top:20px">${weekly_recommend.sport}</textarea>
        </div>
