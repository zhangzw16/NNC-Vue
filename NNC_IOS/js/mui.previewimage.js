(function($, window) {
	...
	var template = '<div id="{{id}}" class="mui-slider mui-preview-image mui-fullscreen yxqScreen"><i class="yxqClose"></i><div class="mui-preview-header">{{header}}</div><div class="mui-slider-group"></div><div class="mui-preview-footer mui-hidden">{{footer}}</div><div class="mui-preview-loading"><span class="mui-spinner mui-spinner-white"></span></div></div>';
	var itemTemplate = '<div class="mui-slider-item mui-zoom-wrapper {{className}} yxqImgbox" style=""><div class="mui-zoom-scroller" style="width:90%;height:80%;margin:10% auto"><img src="{{src}}" data-preview-lazyload="{{lazyload}}" style="{{style}}" class="mui-zoom"></div></div>';
...
//		this.empty();
	...
	$(document.body).on('tap', '.yxqClose', function() {
