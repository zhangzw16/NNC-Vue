 ...
 * =====================================================
 */
//var URL='http://114.242.25.126:7080/NNC/rest/';
//var URL='http://192.168.0.47:8080/NNC/rest/';
var URL='http://118.89.241.96:8080/NNC/rest/';
//var URL ='http://192.168.43.127:8080/NNC/rest/'; 
//var URL ='http://172.20.10.12:8080/NNC/rest/'; 
...
function() {
	...
	function(a, b, c) {
		...
		k.prototype.init = function() {
			this.toggleWidth = this.element.offsetWidth, this.handleWidth = this.handle.offsetWidth, this.handleX = this.toggleWidth - this.handleWidth - 1
...
function filter(value) {
  ...
  var arrMg = ["中共","民主","共产党","习近平","毛主席","毛泽东",
  				"中国共产党","反共","反党","反国家","游行"
  				,"集会","强奸","走私","强暴","套套","摇头丸",
  				"白粉","冰毒","海洛因","假钞","人民币","假币",
  				"日","操","我日","干你","我操","操你","操你妈",
  				"干你妈","傻逼","大逼","高潮","鸡鸡","鸡巴","做爱",
  				"打炮","打洞","插入","抽插","贱人","贱逼","骚逼",
  				"牛逼","妈的","他妈的","你妈逼","草你妈","fuck", "tmd"];
  // 显示的内容--showContent
